...
sign_1.describe("prop, explicit", async ({ assert, inspect }) => {
...
sign_1.describe("prop, inferred", async ({ assert, inspect }) => {
    {
        const expected = 1;
...
sign_1.describe("prop, missing propertyKey", async ({ assert, inspect }) => {
    {
        const value = { a: "a" };
