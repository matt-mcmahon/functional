 ...
 *
 */
export type Head<AS extends any[]> = AS extends [infer A, ...any[]] ? A : never
 ...
 *
 */
export type Tail<T extends any[]> = T extends [any, ...infer TT]
  ? TT
  : never
 ...
 */
export type Prepend<A, BS extends any[]> = [A, ...BS] extends [...infer U]
  ? U
  : BS
...
export type Drop<N extends number, T extends any[], I extends any[] = []> = {
  MORE: Drop<N, Tail<T>, Prepend<any, I>>
  DONE: T
...
> = {
  MORE: GapsOf<
    ...
    Next<I>
  >
  DONE: Concat<TN, Drop<Pos<I>, T2> extends infer D ? Cast<D, any[]> : never>
